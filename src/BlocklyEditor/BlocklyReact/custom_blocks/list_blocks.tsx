...
//BlocklyJS[funklyBlockType.LISTWITH] = funklyCodegen(funklyBlockType.LISTWITH)
//console.trace(BlocklyJS[funklyBlockType.LISTWITH])
...
BlocklyJS[funklyBlockType.LIST] = funklyCodegen(funklyBlockType.LIST)
Blocks[funklyBlockType.LIST] = {
  /**
